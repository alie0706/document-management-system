...
switch($_GET[act]){
  ...
  default:
    ...
    echo "<form name='tambah' method=POST action='?module=docin&act=cari' onSubmit=\"return validasi()\">";?>
		  <div class="card-header">
                            <strong class="card-title">Report Document</strong>
                        </div>
                        <div class="card-body">
	  ...
	  $(document).ready(function(){
        $("#tgl2").datepicker({
          ...
          <tr><td>Date </td>     <td> : <input type=text name='tgl1' id="tgl1" onBlur='validate(this)'> from <input type=text name='tgl2' id="tgl2" onBlur='validate(this)'> </td></tr>
          <?php
		  echo "
  ...
  $tgl1=$_POST[tgl1];
  $tgl2=$_POST[tgl2];
  $ceck=mysql_query("SELECT * FROM upload a, upload_d b where a.nomtrak=b.nomtrak AND a.inputtgl BETWEEN '$tgl1' AND '$tgl2'");
  $c=mysql_fetch_array($ceck);?>
  <div class="card-body">
    <a class="btn btn-primary" href="./inc/docin.php?tgl1=<?php echo $tgl1;?>&tgl2=<?php echo $tgl2;?>" target="_blank" role="button">Print</a></div>
	...
	$rupi     = "Rp. ";
    $tampil=mysql_query("SELECT * FROM upload a, upload_d b where a.nomtrak=b.nomtrak AND a.inputtgl BETWEEN '$tgl1' AND '$tgl2' ORDER BY a.docid ASC limit $posisi,$batas");
...
//$no2=0;	
	while ($r=mysql_fetch_array($tampil)){
	 echo   "<tr><td align=center>$no</td>
				...
				echo "<td align=center><a href='?module=docin&act=detailfile_d&docid_d=$r[docid_d]&nomtrak=$r[nomtrak]'><img src=images/detail.gif border=0></a> 
