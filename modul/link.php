...
switch($_GET[act]){
  ...
  if($_SESSION[leveluser]=='admin'){
    ...
    echo "<fieldset><legend><b>Data Link Retensi</b></legend><br/>
	<table>
    ...
    $z=mysql_fetch_array($x);
       echo "<tr><td>$no</td>
             ...
             <td><a href=downlot.php?file=$r[fileimage]>$r[fileimage]</a></td>
				 ...
				 <td>$r[namajenis]</td>
				 <td>$r[nama]</td>
             <td><a href=?module=retensilink&act=detail&id=$r[docid]><img src=images/ico_edit_16.png border=0 border=0 title='upload'></a> | 
	 ...
	 echo "<fieldset><legend>Data Link Retensi</b></h2>
	<table>
...
echo "<tr><td>Tanggal Retensi <td>: <input type=text name='retentiondate' id='tgla' value='$r[inputtgl]' readonly>";
 echo "<tr><td colspan=2>
		  ...
		  <a href=?module=retensilink&act=detailE&id=$r[docid]>Tambah Upload</a>
<table>
    ...
    while ($r=mysql_fetch_array($tampil)){
       ...
       echo "<tr><td>$no</td>
             ...
             <td><a href=downlot.php?file=$r[image_d]>$r[image_d]</a></td>
				 ...
				 <td>$r[keterangan]</td>
				 <td>$r[nama]</td>
                 <td><a href=?module=retensilink&act=editan&id=$r[upl_d]><img src=images/edit.jpg border=0 border=0 title='edit'></a> | 
